...
export default function MyFoundReports() {
  ...
  useEffect(() => {
    getFoundItems()
      ...
      .catch((requestError) =>
        setError(
          getApiError(requestError, "Unable to load your found reports.")
        )
      )
  ...
  return (
    <ClientPage
      ...
      description="Track items you found and submitted."
      action={
        <Link
    ...
    >
      {loading ? (
        ...
        <EmptyState message="You have not reported a found item yet." />
      ) : (
